...
## 6. Scénář mise Tajemství dávných obrů pro Operátora mise

### Krok 1

> Tady PAX. Dělníci při stavbě věže našli kost a stopu. Práci zastavili. Prozkoumej nálezy a zjisti, kam můžeme věž přesunout. Začni u staveniště na mapě.

### Krok 7

> Dělníci dohledali záznam o dalším vzorku. Podívej se, kde ho nechali, a najdi ho podle mapy.
...
- **7_1 — lístek:** „Vzorek R jsme odebrali na Rozcestí při kontrole náhradního staveniště. Neotevřený zůstal u značky Rozcestí. Prosíme o prozkoumání.“ Pod snímkem je stejný symbol jako na mapě a obalu bloku.
- **11_1 — legenda:** „Modrá čára: nejvyšší voda v záznamech Centrály. Červená čára: nejnižší přípustná vyhlídka věže. Podívej se, kde leží vršek.“ Výřez a panorama mají společný symbol Travnatého vršku.
- **Atlas:** osm velkých modelových dílů. Blok 1: trup, pánev, čtyři končetiny. Blok R: hlava a ocas. První určení může zůstat nerozhodnuté; dítě nesmí být tlačeno do správného tipu. Konečná karta Triceratops musí přesně odpovídat dodanému modelu. Anatomickou věrnost ověřit před výrobou.
- **Fotografie:** dokumentují místo a původ nálezů, stopa neurčuje stejného jedince ani druh kostry. Kolečko je ztracená součást dělnického modelu, nikdo je úmyslně nepodstrčil.

## 2. Protokol a původ nálezů

Pole uvedená v tabulce zůstávají. V každém jsou obrázkové možnosti k zakroužkování; názvy čte průvodce. U vzorků jsou obrysy osmi dílů: u každého dítě označí symbol staveniště nebo Rozcestí ještě před spojením kostry. Misky zachovají původ do té doby. Část „Náhradní místa“ obsahuje louku/stromy, plošinu/vodu a Rozcestí/nález. U vršku se označí čtyři doložené kontroly. Pracovní určení se nemaže; potvrzené určení má samostatné pole.
